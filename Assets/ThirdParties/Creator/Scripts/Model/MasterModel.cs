        ...
        callbackData.AddListener(() =>
        {
            switch (type)
            {
                case MasterDataType.Booster1:
                    {
                        GameManager.Instance.GetMasterModelView().Post(2, MasterDataType.Booster1, "Tutorial");
                        dataBooster1.UnLock();
                    }
                    break;
                case MasterDataType.Booster2:
                    {
                        GameManager.Instance.GetMasterModelView().Post(2, MasterDataType.Booster2, "Tutorial");
                        dataBooster2.UnLock();
                    }
                    break;
                case MasterDataType.Booster3:
                    {
                        GameManager.Instance.GetMasterModelView().Post(2, MasterDataType.Booster3, "Tutorial");
                        dataBooster3.UnLock();
                    }
                    break;
                case MasterDataType.Booster4:
                    {
                        GameManager.Instance.GetMasterModelView().Post(2, MasterDataType.Booster4, "Tutorial");
                        dataBooster4.UnLock();
                    }
                    break;
            }
