...
namespace TMPro.EditorUtilities
{
    public static class UICustomMenu
    {
        ...
        [MenuItem("GameObject/UI/UICustomMenu/ButtonGameCoin", false, 3)]
        static public void AddButtonGameCoin(MenuCommand menuCommand)
        {
            GameObject go = CreateButton<ButtonGameCoin>(GetStandardResources(), "0.0");
            ButtonGameIAP gameCoin = go.GetComponent<ButtonGameIAP>();
            gameCoin.textPrice = go.GetComponentInChildren<TextMeshProUGUI>();
            PlaceUIElementRoot(go, menuCommand);
        }
