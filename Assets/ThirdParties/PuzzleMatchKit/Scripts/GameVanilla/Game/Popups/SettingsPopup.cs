...
#pragma warning restore 649
        ...
        protected override void Awake()
        {
            ...
            Assert.IsNotNull(notificationsToggle);
        ...
        protected override void Start()
        {
            ...
            notificationsToggle.isOn = PlayerPrefs.GetInt("notifications_enabled") == 1;
        }
        ...
        public void OnSaveButtonPressed()
        {
            ...
            PlayerPrefs.SetInt("notifications_enabled", currentNotifications);
        ...
        {
            Creator.ManagerDirector.PushScene(AlertPopupController.ALERTPOPUP_SCENE_NAME, new AlertPopupController.DataPopup("Help", "Do you need help?"));
        }
        ...
        {
           // Creator.ManagerDirector.PushScene(AlertPopupController.ALERTPOPUP_SCENE_NAME, new AlertPopupController.DataPopup("About", "Created by gamevanilla.\n Copyright (C) 2017."));
        }
        ...
        /// <summary>
        /// Called when the notifications toggle is changed.
        /// </summary>
        public void OnNotificationsToggleChanged()
        {
            currentNotifications = notificationsToggle.isOn ? 1 : 0;
        }
    }
}
